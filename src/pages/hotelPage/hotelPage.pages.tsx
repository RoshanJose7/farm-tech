...
const CustomCheckBox = (props: { value: any; name: string }) => {
  return (
    <div className="veggies mb-3">
      <Field
        className="veggies-checkbox"
        name={props.name}
        type="checkbox"
        value={props.value}
      />
  ...
  return (
    <div id="hotel">
      ...
      <div id="hotel-content">
        <div id="hotel-text">
          <h2>
            Get Fresh Vegetables, with exclusive offers and delivery facilities.
          </h2>
        </div>
      </div>
